...
export interface OutTextBoxGeneralProps {
    outputText: string;
    error: string;
}

export interface OutTextBoxViewProps {
    toolLabel: string;
...
export function OutTextBoxView(props: OutTextBoxViewProps) {
    return (
