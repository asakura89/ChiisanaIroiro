...
namespace Nvy {
    ...
    public static class NameValueItemExtensions {
        ...
        public static IEnumerable<NameValueItem> AsNameValueList<T>(this IEnumerable<T> dataList,
        ...
        public static String AsDelimitedString(this IEnumerable<NameValueItem> nameValueList) {
            String[] delimitedStringList =
                nameValueList.Select(item => item.Name + NameValueItem.ItemDelimiter + item.Value).ToArray();
            String delimitedString = String.Join(NameValueItem.ListDelimiter.ToString(), delimitedStringList);

            return delimitedString;
        }

        public static String AsDelimitedString<T>(this IEnumerable<T> dataList, Func<T, String> nameSelector,
