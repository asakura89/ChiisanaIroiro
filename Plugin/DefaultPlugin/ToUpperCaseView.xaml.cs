...
namespace DefaultPlugin {
    public partial class ToUpperCaseView : UserControl, IViewablePlugin {
        public String ComponentName => "To Upper Case";
        ...
        void ProcessButton_Click(Object sender, RoutedEventArgs e) {
            ...
            String output = currentTextInfo.ToUpper(CommonView.Input);
